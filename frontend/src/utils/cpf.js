...
export const normalizeCPF = (cpfRaw) => cpfRaw.replace(DIGITS_ONLY_REGEX, "");
export const formatCPF = (cpfRaw) => {
...
const calculateVerifierDigit = (digits, factorStart) => {
    let total = 0;
    for (let index = 0; index < digits.length; index += 1) {
...
export const validateCPF = (cpfRaw) => {
